...
export function createApp(config: ServerConfig) {
  ...
  app.get("/", async (c) => {
    try {
      ...
      c.header("Content-Security-Policy", "default-src 'none'; style-src 'self'; script-src 'self' 'unsafe-inline' https://www.googletagmanager.com https://storage.ko-fi.com; connect-src 'self' https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com; img-src 'self' https://raw.githubusercontent.com https://www.google-analytics.com https://*.google-analytics.com https://*.googletagmanager.com https://storage.ko-fi.com https://ko-fi.com; frame-ancestors 'none'");
      return c.html(html);
    } catch {
      return c.notFound();
    }
