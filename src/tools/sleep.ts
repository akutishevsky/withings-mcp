...
export function registerSleepTools(server: any, mcpAccessToken: string) {
  ...
  server.registerTool(
    "get_sleep",
    {
      ...
      inputSchema: zodToJsonSchema(getSleepInputSchema, "getSleepInput"),
      outputSchema: zodToJsonSchema(sleepDataOutputSchema, "sleepDataOutput"),
    },
    async (args: any) => {
  ...
  server.registerTool(
    "get_sleep_summary",
    {
      ...
      inputSchema: zodToJsonSchema(getSleepSummaryInputSchema, "getSleepSummaryInput"),
      outputSchema: zodToJsonSchema(sleepSummaryOutputSchema, "sleepSummaryOutput"),
    },
    async (args: any) => {
